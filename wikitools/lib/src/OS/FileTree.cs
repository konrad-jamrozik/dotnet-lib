...
namespace Wikitools.Lib.OS
{
    ...
    {
        // kj2 2 consider making FileTree implement TreeData<string> instead
        ...
        {
            // kj2 2 make this method Lazy
            // kj2 2 implement properly walking the tree: decoupled from IFilesystem
