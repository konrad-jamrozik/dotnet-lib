    ...
    private static object[] GetContent(
        ...
        =>
            new object[]
            {
                ...
                string.Format(AuthorDescriptionFormat, 5, 7),
                "",
                ...
                "",
                string.Format(AuthorDescriptionFormat, 10, 28),
                "",
                GitAuthorStats.TabularData(authorDataRowsLast30Days),
                "",
                string.Format(FileDescriptionFormat, 10, 7),
                "",
                GitFileStats.TabularData(fileDataRowsLast7Days),
                "",
                string.Format(FileDescriptionFormat, 20, 28),
                "",
                GitFileStats.TabularData(fileDataRowsLast30Days),
                "",
                string.Format(PageViewDescriptionFormat, 10, 7),
                "",
                PageViewStats.TabularData(pageViewDataRowsLast7Days),
                "",
                string.Format(PageViewDescriptionFormat, 30, 28),
                "",
