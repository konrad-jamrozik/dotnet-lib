    ...
    : ValidWikiPagesStats(ValidStatsForMonth(Stats))
{
    ...
    public ValidWikiPagesStatsForMonth(IEnumerable<WikiPageStats> stats, DateMonth month) 
        // kja-DaySpan I need to introduce some type like DaySpan, which is a pair of (DateDay start, DateDay end)
        ...
        // kja-DaySpan also: rename existing DayRange substrings to DaySpan.
