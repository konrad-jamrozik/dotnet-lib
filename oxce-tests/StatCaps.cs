...
namespace OxceTests
{
    ...
    {
        // @formatter:off
        private static readonly StatCaps SoldierStatCaps  = new StatCaps(65, 90, 45, 100, 60, 90, 70, 50, 100, 50, 90, 120);
        private static readonly StatCaps HybridStatCaps   = new StatCaps(65, 70, 40, 100, 70, 90, 70, 40, 90, 90, 90, 120);
        private static readonly StatCaps DogStatCaps      = new StatCaps(100, 130, 50, 40, 110, 10, 10, 2, 40, 0, 140, 220);
        private static readonly StatCaps RatStatCaps      = new StatCaps(65, 100, 18, 30, 80, 0, 0, 2, 45, 0, 60, 120);
